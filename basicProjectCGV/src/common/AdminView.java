...
//		cinemaList();
			...
			if(reg.checkshowtiem(showtime)){
				...
				System.out.println("상영시간을 제대로 입력해주세요. (HH:MM)");
				continue;
			}
	...
	private void reserveList(){
		for(ReserveVO res : reserveSv.readAllReserve()){
			...
			System.out.println("\t\t상영관 종류 : " + res.getCinema_name());
			System.out.println("\t\t관번호 :" + res.getCinema_id() + " 관");
			System.out.println("\t\t회원 이름 : " + res.getMem_id());
			System.out.println("\t\t좌석 번호 : " + res.getSeat_no() + "번 좌석");
			System.out.println("\t\t입장 가격 : " + res.getCinema_price() + "원");
			System.out.println("└―――――――――――━―――――――――┘");
			System.out.println();
		}
	}
	...
	private void managerSales(){
		do{
			...
			System.out.println();
			System.out.println("┌―――――――――――――――――――――┐");
			System.out.println("\t\t영화관 매출관리 목록");
			System.out.println("\t\t<뒤로가기는 0번 입니다.>");
			System.out.println("└―――――――――――――――――――――┘");			
			System.out.print("[ 1 ] 영화관 총 매출");
			System.out.println("\t[ 2 ] 상영관별 매출");
			System.out.print("[ 3 ] 영화별 매출");
			System.out.println("\t\t[ 0 ] 나가기");
			try{
				input = sc.nextInt();
			} catch (IndexOutOfBoundsException e) {
	...
	private void movieSales(){
		...
		movieList();
		System.out.println();
		System.out.print("매출을 조회할 영화를 선택하세요 : ");
		try{
			input = sc.nextInt();
		} catch (IndexOutOfBoundsException e) {
			msg();
	...
	private void cinemaSales(){
		...
		cinemaList();
		System.out.println();
		System.out.print("매출을 조회할 상영관을 선택하세요 : ");
		try{
			input = sc.nextInt();
		} catch (IndexOutOfBoundsException e) {
			msg();
	...
	private void changestmember(){
		do{
			...
			System.out.println("┌―――――――――――――――――――――――――――┐");
			System.out.println("\t\t\t    ※ 주의사항 ※");
			System.out.println("\t\t회원을 비활성화 시키는 메뉴입니다.");
			System.out.println("\t\t      < 뒤로가기는 0번 입니다 >");
			System.out.println("└――――――――――――━――――――――――――――┘");
			System.out.println();
