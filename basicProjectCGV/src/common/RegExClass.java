...
public class RegExClass {
	...
	/**
	 * 상영시간 추가시 시간단위 양식을 확인하는 메서드
	 * @author 이상헌
	 * @since 2020-09-11
	 * 
	 */
	public boolean checkshowtiem(String showtime){
		String regex_showtime = "(2[0-3]|[0-1][0-9]):([0-5]\\d)";
		return Pattern.matches(regex_showtime, showtime);
	}
}
